...
image:
  path: /assets/img/posts/museum_resolution_header.png
  alt: ["Selfies of me outside a bunch of museums in Chicago with the label 'Museum Resolution 2024'"]
---

# My Museum Resolution

Like many people, I have had an ambivalent relationship with new year's resolutions. I've often vaguely tried to instill better habits or quit bad ones, usually without much commitment or success. A couple of years ago, though, I was inspired by a screenshot of a Tumblr post to try a new approach: 
...
3. Have the word "museum" in their name
...
With the criteria established, I ended up visiting the following museums (in chronological order and included on map below):

1. [Swedish American Museum](https://www.swedishamericanmuseum.org/)
2. [Museum of Contemporary Photography](https://mocp.org/)
3. [Chinese American Museum of Chicago](https://www.camochicago.org/)
4. [Chicago Maritime Museum](https://www.chicagomaritimemuseum.org/)
5. [Edgewater Historical Society Museum](https://www.edgewaterhistory.org/)
6. [International Museum of Surgical Science](https://www.imss.org/)
7. [Driehaus Museum](https://www.driehausmuseum.org/)
8. [Chicago Fed Money Museum](https://www.chicagofed.org/education/money-museum/index)
9. [Design Museum of Chicago](https://designchicago.org/)
10. [American Writers Museum](https://www.americanwritersmuseum.org/)
...
I did not use any library museum passes for this resolution; the program has been changed substantially since 2024. If I were doing the resolution again, I would make sure to check the [Chicago Public Library digital museum passes program](https://www.chipublib.org/news/digital-museum-passes-reserve-online/) to see if I could get free or reduced-price access to museums that charge for admission. (Several of the museums I visted have free admission by default regardless.) 
...
That said, I will note two museums that I would recommend broadly -- not *over* the others but to a particularly wide range of people:
...
However, my biggest recommendation is just: go to more museums! There are dozens and dozens of museums in a city like Chicago and they reflect an immense amount of care and effort from people working to curate and communicate information about different communities and subject areas. Going to museums in person is a chance to engage with information in an embodied way distinct from the screen-mediated day-to-day. Something like a new year's resolution can provide motivation and structure, but it's certainly not necessary.


*Map creation & embedding followed [this tutorial](https://jayrobwilliams.com/posts/2020/09/jekyll-html) with some updates to handle Carto API key requirements. Cover photos were previously shared in [the above-linked Bluesky thread](https://bsky.app/profile/laurie-merrell.bsky.social/post/3ldmgj3pdvv2q). I found the Tumblr screenshot & [original citation](https://www.tumblr.com/songofsaraneth/717166954063003648/every-time-i-ask-people-if-they-do-any-new-years) in [this Reddit post](https://www.reddit.com/r/CuratedTumblr/comments/18n2wot/you_can_make_fun_ones/).*